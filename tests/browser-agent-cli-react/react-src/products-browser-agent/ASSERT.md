...
- File exists under module `react/src/products/browser-agent.{ts,tsx,js}`.
- File content contains `43761`.
- File content contains `browser-agent` (case-sensitive preferred for id string).
...
- Missing product file fails shared React parameterization.
